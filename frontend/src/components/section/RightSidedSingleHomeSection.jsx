        ...
        <section className="w-full bg-zinc-900 py-12 px-4 sm:px-6 lg:px-8 pt-20 lg:pt-30">
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                    ...
                    <div className="w-full h-[300px] sm:h-[550px] lg:h-[550px] rounded-lg overflow-hidden bg-white shadow-2xl md:hidden">
                        <video
                    ...
                    {/* Left Side - Video Container */}
                    <div className="w-full h-[300px] sm:h-[550px] lg:h-[550px] rounded-lg overflow-hidden bg-white shadow-2xl hidden md:block">
                        <video
                            className="w-full h-full object-cover"
                            autoPlay
                            loop
